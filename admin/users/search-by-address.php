...
if(isset($_GET["address"])){
    ...
    $sql = "SELECT * FROM users WHERE `address` LIKE '%$address%'";
}
else{
...
<div class="container">
    ...
    <h1 class="display-l my-5 text-center bg-success">Search User By Address</h1>

        <form class="row mb-3" action="" method="get">
            <div class="col-10">
                <input type="text" value="<?php if(isset($_GET["address"])){ echo $_GET["address"]; } ?>" name="address" id="address" class="form-control">
            </div>

            <div class="col-2">
               <button type="submit" class="btn btn-primary">Search</button>
             <a href="../users/search-by-address.php" class="btn btn-secondary">Reset</a>
            </div>
        </form>
